...
const BOOKS = [
  { id: 'jogos-de-poder', 
    ...
    idioma: 'Português',
     ...
     sinopse: 'Serena Greco tentou ao máximo fugir do fato de ser filha da família que comanda a máfia em Chicago. Mas numa armadilha do próprio pai, ela se torna o elo entre a Outfit e a Cosa Nostra.', 
  ...
  { id: 'jogos-de-ruina', 
    ...
    lancamento: '2021', idioma: 'Português', paginas: 233, 
    ebook: 'https://a.co/d/0iLdRCc4', 
    sinopse: 'O segundo capítulo da saga Jogos da Máfia. Quando as peças do tabuleiro mudam, as regras do jogo também mudam.', 
    tropes: ['Máfia Romance', 'Dark Romance', 'Famílias Rivais'], 
    categoria: 'pt' },
  { id: 'jogos-de-vitoria', 
    ...
    sinopse: 'O capítulo final da Série Jogos da Máfia. A batalha entre as famílias chega ao fim, mas nenhuma vitória vem sem um preço.', 
    tropes: ['Máfia Romance', 'Dark Romance', 'Forced Proximity'], 
    categoria: 'pt' },
  { id: 'faca-um-pedido', 
    ...
    sinopse: 'Um pedido feito sem pensar. Uma promessa que não deveria ser cumprida. E dois corações que insistem em sentir o que não deveriam.', 
  ...
  { id: 'eu-pediria-por-voce', 
    ...
    sinopse: 'Theo Jones amou Maeve Carter em todas as linhas temporais. O que aconteceria se Theo viajasse no tempo e encontrasse uma Maeve que nunca o conheceu?', 
    tropes: ['Second Chance', 'Enemies to Lovers', 'Secret'], 
    categoria: 'pt' },
  { id: 'contrato-em-las-vegas', 
    ...
    sinopse: 'Uma noite em Las Vegas, um contrato e duas pessoas que deveriam saber melhor do que misturar negócios com sentimentos.', 
    tropes: ['Casamento por Conveniência', 'Forced Proximity', 'Enemies to Lovers'], 
    categoria: 'pt' },
  { id: 'contos-de-contrato', 
    ...
    sinopse: 'Histórias extras do universo Las Vegas. Contos que expandem os casais favoritos.', 
    tropes: ['Casamento por Conveniência', 'Slow Burn', 'Short Story'], 
    categoria: 'pt' },
  { id: 'os-padrinhos', 
    titulo: 'Os Padrinhos', 
    serie: null, 
    ...
    lancamento: '2020', 
    idioma: 'Português', 
    paginas: 287, ebook: 'https://a.co/d/06epa6a3', 
    sinopse: 'Duas pessoas que se odeiam mais do que tudo precisam organizar um casamento juntos. 30 semanas no Top 100 da Amazon.', 
  ...
  { id: 'o-pedido', 
    ...
    sinopse: 'O que acontece quando o par favorito tem mais história para contar? Harry surpreenderá Amy.', 
    tropes: ['Enemies to Lovers', 'Short Story'], 
    categoria: 'pt' },
  { id: 'lance-proibido', 
    ...
    sinopse: 'Quando o amor é proibido, a única saída é ir contra tudo e todos.', 
    tropes: ['Forbidden Romance', 'Enemies to Lovers', 'Slow Burn'], 
    categoria: 'pt' },
  { id: 'os-socios', 
    titulo: 'Os Sócios', 
    serie: null, 
    ...
    sinopse: 'Uma sociedade que deveria ser só de negócios. Dois corações que decidiram ignorar o memorando.', 
    tropes: ['Office Romance', 'Enemies to Lovers', 'Fake Dating'], 
    categoria: 'pt' },
  { id: 'alianca-perfeita', 
    titulo: 'Aliança Perfeita', 
    serie: null, 
    capa: 'CAPAS/12. Aliança Perfeita.jpg', 
    lancamento: '2022', idioma: 'Português', 
    paginas: 411, 
    ebook: 'https://a.co/d/0axA1E4e', 
    sinopse: 'Uma aliança arranjada, um casamento de conveniência e dois estranhos descobrindo que o perfeito pode surpreender.', 
    tropes: ['Casamento por Conveniência', 'Grumpy x Sunshine', 'Slow Burn'], 
    categoria: 'pt' },
  { id: 'meu-detestavel-chefe', 
    ...
    sinopse: 'Ele é arrogante, exigente e impossível de ignorar. Ela jurou não misturar trabalho com sentimentos.', tropes: ['Office Romance', 'Boss/Employee', 'Enemies to Lovers'], 
    categoria: 'pt' },
  { id: 'protegida-guarda-costas', 
    ...
    sinopse: 'Quando a pessoa encarregada de protegê-la se torna o maior perigo para o seu coração.', 
    tropes: ['Bodyguard Romance', 'Forced Proximity', 'Grumpy x Sunshine'], 
    categoria: 'pt' },
  { id: 'manual-conquista', 
    ...
    sinopse: 'Nenhum manual prepara para o amor real, especialmente quando o objeto é exatamente quem você não deveria querer.', 
    tropes: ['Enemies to Lovers', 'Fake Dating', 'Small Town'], 
    categoria: 'pt' },
  { id: 'um-comeco-imperfeito', 
    titulo: 'Um Começo Imperfeito', 
    serie: null, capa: 'CAPAS/16. Um Começo Imperfeito a bebê secreta do magnata.jpg', 
    lancamento: '2023', 
    idioma: 'Português', 
    paginas: 305, 
    ebook: 'https://a.co/d/00su91QD', 
    sinopse: 'Uma bebê secreta, um magnata que não estava nos planos e um começo que é tudo menos perfeito.', 
    tropes: ['Secret Baby', 'Single Parent', 'Second Chance'], 
    categoria: 'pt' },
  { id: 'o-principio-do-amor', 
    ...
    sinopse: 'No princípio era a amizade. Depois vieram os olhares e a percepção inevitável de que algo havia mudado.', 
    tropes: ['Friends to Lovers', 'Slow Burn', 'Coming of Age'], 
    categoria: 'pt' },
  { id: 'temporada-de-farsa', 
    titulo: 'Temporada de Farsa & Gelo', 
    serie: null, 
    ...
    sinopse: 'Uma farsa para salvar a temporada, um jogador de gelo que é tudo menos frio.', 
    tropes: ['Fake Dating', 'Sports Romance', 'Enemies to Lovers'], 
    categoria: 'pt' },
  { id: 'amor-por-acidente', 
   ...
   sinopse: 'Uma gravidez acidental, um homem que ela mal conhece e a descoberta de que acidentes podem ser a melhor coisa.', 
   tropes: ['Enemies to Lovers', 'Gravidez Acidental', 'Forced Proximity'], 
   categoria: 'pt' },
  { id: 'chefe-quase-perfeito', 
    ...
    lancamento: '2024', idioma: 'Português', 
    paginas: 597, ebook: 'https://a.co/d/04Y02MC0', 
    sinopse: 'Ele é quase perfeito, exceto pelo temperamento impossível e pela tendência de cruzar linhas.', 
    tropes: ['Office Romance', 'Boss/Employee', 'Enemies to Lovers'], 
    categoria: 'pt' },
  { id: 'como-salvar-mafioso', 
    ...
    tropes: ['Máfia Romance', 'Enemies to Lovers', 'Dark Romance'], 
    categoria: 'pt' },
  { id: 'improvisado', 
    titulo: 'Improvisado', 
    serie: 'O Clube dos Pais Solteiros do Hóquei', 
    capa: 'CAPAS/22. Improvisado O Clube dos Pais Solteiros do Hóquei.jpg', 
    lancamento: '2024', idioma: 'Português', paginas: 551, ebook: 'https://a.co/d/0g4GXayq', 
    sinopse: 'Pais solteiros, filhos caóticos e um grupo de jogadores de hóquei que aprendem que improvisar pode funcionar.', 
    tropes: ['Sports Romance', 'Single Parent', 'Enemies to Lovers'], 
    categoria: 'pt' },
  { id: 'maid-for-each-other', 
    ...
    sinopse: "An enemies-to-lovers story that proves being thrown together in the most inconvenient way possible is sometimes the universe's best plan.", tropes: ['Enemies to Lovers', 'Fake Dating', 'Forced Proximity'], 
    categoria: 'idiomas' },
  { id: 'seduction-effect', 
    ...
    sinopse: 'A slow-burn office romance where the rules are clear, the attraction is undeniable.', 
    tropes: ['Office Romance', 'Enemies to Lovers', 'Slow Burn'], 
    categoria: 'idiomas' },
  { id: 'les-temoins', 
    ...
    sinopse: "Deux témoins de mariage qui se détestent, un mariage à organiser et une évidence qui refuse d'être ignorée.", 
  ...
  { id: 'doces-rivais', 
    ...
    sinopse: 'Uma rivalidade açucarada, uma pequena cidade e dois corações que insistem em bater mais rápido.', 
    tropes: ['Enemies to Lovers', 'Small Town', 'Grumpy x Sunshine'], 
